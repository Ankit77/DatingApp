...
class HttpUrlConnectionMapsHttpClient extends com.chatapp.placesautocomplete.network.AbstractPlacesHttpClient {
    ...
    @Override
    protected <T extends PlacesApiResponse> T executeNetworkRequest(final Uri uri, final com.chatapp.placesautocomplete.network.ResponseHandler<T> handler) throws IOException {
